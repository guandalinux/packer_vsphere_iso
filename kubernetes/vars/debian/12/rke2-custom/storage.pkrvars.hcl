...
vsphere_library    = "K8S - DEBIAN 12 - RKE2 CUSTOM"

// VM Config
vm_name        = "TPL-DEBIAN-12-RKE2-CUSTOM-STORAGE"
vm_system_type = "storage"
vm_user_name   = "debian"
vm_destroy     = true
vm_export_mode = "ovf"

// RKE2 Provider Type
rke2_provider_type = "custom"

// Cloud Init
cloud_init_datasources = ["OVF", "VMware", "None"]
...
// VM Disk
vm_disk_controller_type = ["pvscsi", "pvscsi", "pvscsi", "pvscsi"]
vm_disk_config          = {
  "0" = {
